<?php
    ...
    $sqlTask = "SELECT * FROM `tasks` WHERE `status` = 'niet klaar'";
...
while($row = $allLists->fetch(PDO::FETCH_ASSOC))
{
   ...
   <tr>
        ...
        <td><button>Filter taken op dit lijst</button></td>
   </tr>
...
<a href="FilterStatusDone.php"><button>Filteren op status</button></a>
